...
from server.chat import (chat, knowledge_base_chat, knowledge_base_chat_once, openai_chat,
                         search_engine_chat, agent_chat, chat_abstract, process_uploaded_file,
                         process_uploaded_text, test_upload)
...
def create_app():
    app = FastAPI(
        title="Case-KnownledgeBase-glm API Server",
        version=VERSION
    )
    ...
    app.post("/chat/test_upload",
             tags=["Chat"],
             summary="测试文件上传")(test_upload)
    
    app.post("/chat/process_uploaded_file",
             tags=["Chat"],
             summary="处理输入docx文件")(process_uploaded_file)
    
    app.post("/chat/process_uploaded_text",
             tags=["Chat"],
             summary="处理输入text文本")(process_uploaded_text)
    
    app.post("/chat/chat_abstract",
             tags=["Chat"],
             summary="用llm模型对输入进行摘要")(chat_abstract)

    app.post("/chat/knowledge_base_chat",
             tags=["Chat"],
             summary="与知识库对话(流式输出)")(knowledge_base_chat)
    
    app.post("/chat/knowledge_base_chat_once",
             tags=["Chat"],
             summary="与知识库对话(单次输出)")(knowledge_base_chat_once)
