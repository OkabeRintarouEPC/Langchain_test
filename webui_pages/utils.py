...
class ApiRequest:
    ...
    def process_uploaded_file(
        ...
        selected_kb: str = "test1", 
        kb_top_k: int = VECTOR_SEARCH_TOP_K, 
        score_threshold: float = SCORE_THRESHOLD, 
        output_type: int = 0,
    ):
        '''
        对应api.py/chat/process_uploaded_file接口 #TODO: 考虑是否返回json
        ''' 
        data = { 
    ...
    def process_uploaded_text(
        ...
        '''
        对应api.py/chat/process_uploaded_text接口 #TODO: 考虑是否返回json
        ''' 
        data = { 
    ...
    def test_upload(
        ...
        '''
        对应api.py/chat/test_upload接口 #TODO: 考虑是否返回json
        '''
        data = {
            "uploaded_file": uploaded_file,
        }
        ...
        response = self.post("/chat/test_upload", json=data, stream=True)
        return self._httpx_stream2generator(response)
    ...
    def chat_abstract(
        ...
        **kwargs,
        ...
        '''
        对应api.py/chat/chat_abstract接口 #TODO: 考虑是否返回json
        '''
        data = {
            "query": query,
            "history": history,
        ...
        response = self.post("/chat/chat_abstract", json=data, stream=True, **kwargs)
        return self._httpx_stream2generator(response)
    ...
    def knowledge_base_chat_once(
        ...
        '''
        对应api.py/chat/knowledge_base_chat_once接口
        '''
        data = {
            "query": query,
            "knowledge_base_name": knowledge_base_name,
